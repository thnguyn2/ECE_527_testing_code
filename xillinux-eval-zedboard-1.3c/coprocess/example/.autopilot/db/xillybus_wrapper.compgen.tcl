...
set id 12
set name xillybus_wrapper_mux_8to1_sel3_1_1
...
set id 13
set name xillybus_wrapper_mux_16to1_sel4_1_1
set corename simcore_mux
set op mux
set stage_num 1
set max_latency -1
...
set id 15
set name xillybus_wrapper_mul_32s_31ns_62_6
...
set ID 16
set MemName xillybus_wrapper_p_str3
...
# Memory (RAM/ROM)  definition:
set ID 17
set MemName xillybus_wrapper_p_str4
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 7
set AddrRange 4
...
# Memory (RAM/ROM)  definition:
set ID 18
set MemName xillybus_wrapper_p_str5
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 4
set AddrRange 2
...
# Memory (RAM/ROM)  definition:
set ID 19
set MemName xillybus_wrapper_hls_ref_4oPi_table_100_V
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 100
set AddrRange 13
...
# Memory (RAM/ROM)  definition:
set ID 20
set MemName xillybus_wrapper_hls_sin_cos_K0_V
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 30
set AddrRange 256
...
# Memory (RAM/ROM)  definition:
set ID 21
set MemName xillybus_wrapper_hls_sin_cos_K1_V
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 23
set AddrRange 256
...
# Memory (RAM/ROM)  definition:
set ID 22
set MemName xillybus_wrapper_hls_sin_cos_K2_V
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 15
set AddrRange 256
