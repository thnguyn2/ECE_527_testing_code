...
#ifndef __xillybus_wrapper_hls_sin_cos_K2_V_H__
#define __xillybus_wrapper_hls_sin_cos_K2_V_H__
...
struct xillybus_wrapper_hls_sin_cos_K2_V_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(xillybus_wrapper_hls_sin_cos_K2_V_ram) {
...
SC_MODULE(xillybus_wrapper_hls_sin_cos_K2_V) {
...
xillybus_wrapper_hls_sin_cos_K2_V_ram* meminst;


SC_CTOR(xillybus_wrapper_hls_sin_cos_K2_V) {
meminst = new xillybus_wrapper_hls_sin_cos_K2_V_ram("xillybus_wrapper_hls_sin_cos_K2_V_ram");
