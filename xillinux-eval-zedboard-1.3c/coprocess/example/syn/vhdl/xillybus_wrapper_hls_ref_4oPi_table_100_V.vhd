...
entity xillybus_wrapper_hls_ref_4oPi_table_100_V_rom is 
    generic(
             dwidth     : integer := 100; 
             awidth     : integer := 4; 
             mem_size    : integer := 13
...
architecture rtl of xillybus_wrapper_hls_ref_4oPi_table_100_V_rom is 
...
entity xillybus_wrapper_hls_ref_4oPi_table_100_V is
    generic (
...
architecture arch of xillybus_wrapper_hls_ref_4oPi_table_100_V is
    component xillybus_wrapper_hls_ref_4oPi_table_100_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    xillybus_wrapper_hls_ref_4oPi_table_100_V_rom_U :  component xillybus_wrapper_hls_ref_4oPi_table_100_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
