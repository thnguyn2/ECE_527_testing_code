...
if {[file isfile adder_top.autotvin.dat]} {
    file delete -force adder_top.autotvin.dat
}
if {[file isfile adder_top.autotvout.dat]} {
    file delete -force adder_top.autotvout.dat
}
