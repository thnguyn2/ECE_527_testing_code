...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_32s_32s_32_6_U1->din0(grp_fu_174_p0);
    fir_mul_32s_32s_32_6_U1->din1(grp_fu_174_p1);
    fir_mul_32s_32s_32_6_U1->ce(grp_fu_174_ce);
    fir_mul_32s_32s_32_6_U1->dout(grp_fu_174_p2);

    SC_METHOD(thread_ap_clk_no_reset_);
    dont_initialize();
    sensitive << ( ap_clk.pos() );

    SC_METHOD(thread_acc_1_fu_180_p2);
    ...
    SC_METHOD(thread_i_1_fu_168_p2);
    sensitive << ( i_reg_104 );

    SC_METHOD(thread_i_cast_fu_127_p1);
    sensitive << ( i_reg_104 );
    ...
    SC_METHOD(thread_tmp_7_fu_145_p1);
    sensitive << ( i_reg_104 );
    ...
    sc_trace(mVcdFile, i_cast_fu_127_p1, "i_cast_fu_127_p1");
    ...
    sc_trace(mVcdFile, tmp_7_fu_145_p1, "tmp_7_fu_145_p1");
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st9_fsm_8.read())) {
        acc_reg_91 = acc_1_fu_180_p2.read();
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st9_fsm_8.read())) {
        i_reg_104 = i_1_reg_220.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
                !esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0))) {
        i_reg_104 = ap_const_lv5_A;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read())) {
        i_1_reg_220 = i_1_fu_168_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read())) {
        i_cast_reg_192 = i_cast_fu_127_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && esl_seteq<1,1,1>(tmp_fu_131_p3.read(), ap_const_lv1_0))) {
        tmp_1_reg_201 = tmp_1_fu_139_p2.read();
    }
}

void fir::thread_acc_1_fu_180_p2() {
    acc_1_fu_180_p2 = (!grp_fu_174_p2.read().is_01() || !acc_reg_91.read().is_01())? sc_lv<32>(): (sc_bigint<32>(grp_fu_174_p2.read()) + sc_biguint<32>(acc_reg_91.read()));
}
...
void fir::thread_grp_fu_174_ce() {
    grp_fu_174_ce = ap_const_logic_1;
}

void fir::thread_grp_fu_174_p0() {
    grp_fu_174_p0 = c_q0.read();
}

void fir::thread_grp_fu_174_p1() {
    grp_fu_174_p1 = data1_reg_116.read();
}

void fir::thread_i_1_fu_168_p2() {
    i_1_fu_168_p2 = (!i_reg_104.read().is_01() || !ap_const_lv5_1F.is_01())? sc_lv<5>(): (sc_biguint<5>(i_reg_104.read()) + sc_bigint<5>(ap_const_lv5_1F));
}

void fir::thread_i_cast_fu_127_p1() {
    i_cast_fu_127_p1 = esl_sext<32,5>(i_reg_104.read());
}
...
void fir::thread_tmp_1_fu_139_p2() {
    tmp_1_fu_139_p2 = (!i_reg_104.read().is_01() || !ap_const_lv5_0.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_104.read() == ap_const_lv5_0);
}

void fir::thread_tmp_2_fu_149_p2() {
    tmp_2_fu_149_p2 = (!ap_const_lv4_F.is_01() || !tmp_7_fu_145_p1.read().is_01())? sc_lv<4>(): (sc_bigint<4>(ap_const_lv4_F) + sc_biguint<4>(tmp_7_fu_145_p1.read()));
}

void fir::thread_tmp_3_fu_155_p1() {
    tmp_3_fu_155_p1 = esl_zext<64,4>(tmp_2_fu_149_p2.read());
}

void fir::thread_tmp_4_fu_160_p1() {
    tmp_4_fu_160_p1 = esl_zext<64,32>(i_cast_reg_192.read());
}

void fir::thread_tmp_5_fu_164_p1() {
    tmp_5_fu_164_p1 = esl_zext<64,32>(i_cast_reg_192.read());
}

void fir::thread_tmp_7_fu_145_p1() {
    tmp_7_fu_145_p1 = i_reg_104.read().range(4-1, 0);
}

void fir::thread_tmp_fu_131_p3() {
    tmp_fu_131_p3 = i_reg_104.read().range(4, 4);
}
