...
architecture behav of fir is 
    ...
    "fir,hls_ip_2015_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.520000,HLS_SYN_LAT=89,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=180,HLS_SYN_LUT=158}";
    ...
    signal acc_1_fu_180_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (tmp_1_reg_201 = ap_const_lv1_0))) then 
    ...
    acc_1_fu_180_p2 <= std_logic_vector(signed(grp_fu_174_p2) + signed(acc_reg_91));
    ...
    shift_reg_we0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, tmp_1_fu_139_p2, tmp_1_reg_201, tmp_fu_131_p3, ap_sig_cseq_ST_st3_fsm_2)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (tmp_1_reg_201 = ap_const_lv1_0)) or ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (tmp_fu_131_p3 = ap_const_lv1_0) and not((tmp_1_fu_139_p2 = ap_const_lv1_0))))) then 
    ...
    tmp_4_fu_160_p1 <= std_logic_vector(resize(unsigned(i_cast_reg_192),64));
    tmp_5_fu_164_p1 <= std_logic_vector(resize(unsigned(i_cast_reg_192),64));
