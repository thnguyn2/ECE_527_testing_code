; ModuleID = '/home/parallels/source_code/ECE_527_testing_code/testing_code/HLS_demo_code/Vivado_HLS_Tutorial/Interface_Synthesis/lab3/array_io_prj/solution1/.autopilot/db/a.g.1.bc'
...
; <label>:1                                       ; preds = %2, %0
  ...
  %exitcond = icmp eq i32 %i, 32, !dbg !38        ; [#uses=1 type=i1] [debug line = 65:17]
  br i1 %exitcond, label %3, label %2, !dbg !38   ; [debug line = 65:17]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !40 ; [debug line = 65:35]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !40 ; [#uses=1 type=i32] [debug line = 65:35]
  %rem = srem i32 %i, 8, !dbg !42                 ; [#uses=1 type=i32] [debug line = 66:3]
  call void @llvm.dbg.value(metadata !{i32 %rem}, i64 0, metadata !43), !dbg !42 ; [debug line = 66:3] [debug variable = rem]
  %tmp = sext i32 %rem to i64, !dbg !44           ; [#uses=1 type=i64] [debug line = 67:3]
  %acc.addr = getelementptr inbounds [8 x i32]* @acc, i64 0, i64 %tmp, !dbg !44 ; [#uses=2 type=i32*] [debug line = 67:3]
  %acc.load = load i32* %acc.addr, align 4, !dbg !44 ; [#uses=2 type=i32] [debug line = 67:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %acc.load) nounwind
  %tmp.1 = sext i32 %i to i64, !dbg !44           ; [#uses=2 type=i64] [debug line = 67:3]
  %d_i.addr = getelementptr inbounds i16* %d_i, i64 %tmp.1, !dbg !44 ; [#uses=1 type=i16*] [debug line = 67:3]
  %d_i.load = load i16* %d_i.addr, align 2, !dbg !44 ; [#uses=2 type=i16] [debug line = 67:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %d_i.load) nounwind
  %tmp.2 = sext i16 %d_i.load to i32, !dbg !44    ; [#uses=1 type=i32] [debug line = 67:3]
  %temp = add nsw i32 %tmp.2, %acc.load, !dbg !44 ; [#uses=3 type=i32] [debug line = 67:3]
  call void @llvm.dbg.value(metadata !{i32 %temp}, i64 0, metadata !45), !dbg !44 ; [debug line = 67:3] [debug variable = temp]
  store i32 %temp, i32* %acc.addr, align 4, !dbg !46 ; [debug line = 68:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %temp) nounwind
  %tmp.3 = trunc i32 %temp to i16, !dbg !47       ; [#uses=1 type=i16] [debug line = 69:3]
  %d_o.addr = getelementptr inbounds i16* %d_o, i64 %tmp.1, !dbg !47 ; [#uses=1 type=i16*] [debug line = 69:3]
  store i16 %tmp.3, i16* %d_o.addr, align 2, !dbg !47 ; [debug line = 69:3]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !48 ; [#uses=0 type=i32] [debug line = 70:2]
  %i.1 = add nsw i32 %i, 1, !dbg !49              ; [#uses=1 type=i32] [debug line = 65:29]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !50), !dbg !49 ; [debug line = 65:29] [debug variable = i]
...
!39 = metadata !{i32 786443, metadata !36, i32 65, i32 12, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!40 = metadata !{i32 65, i32 35, metadata !41, null}
!41 = metadata !{i32 786443, metadata !39, i32 65, i32 34, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!42 = metadata !{i32 66, i32 3, metadata !41, null}
!43 = metadata !{i32 786688, metadata !36, metadata !"rem", metadata !6, i32 58, metadata !21, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!44 = metadata !{i32 67, i32 3, metadata !41, null}
!45 = metadata !{i32 786688, metadata !36, metadata !"temp", metadata !6, i32 62, metadata !20, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!46 = metadata !{i32 68, i32 3, metadata !41, null}
!47 = metadata !{i32 69, i32 3, metadata !41, null}
!48 = metadata !{i32 70, i32 2, metadata !41, null}
!49 = metadata !{i32 65, i32 29, metadata !39, null}
!50 = metadata !{i32 786688, metadata !36, metadata !"i", metadata !6, i32 58, metadata !21, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!51 = metadata !{i32 71, i32 1, metadata !36, null}
