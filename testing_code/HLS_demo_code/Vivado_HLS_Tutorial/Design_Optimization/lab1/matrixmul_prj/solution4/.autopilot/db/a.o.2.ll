...
; <label>:3                                       ; preds = %1
  ...
  br label %4, !dbg !82                           ; [debug line = 56:25]

; <label>:4                                       ; preds = %6, %3
  %j = phi i2 [ 0, %3 ], [ %j.1, %6 ]             ; [#uses=3 type=i2]
  %exitcond1 = icmp eq i2 %j, -1, !dbg !82        ; [#uses=1 type=i1] [debug line = 56:25]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond1, label %8, label %6, !dbg !82  ; [debug line = 56:25]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @.str3) nounwind, !dbg !83 ; [debug line = 56:40]
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @.str3) nounwind, !dbg !83 ; [#uses=1 type=i32] [debug line = 56:40]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !84 ; [debug line = 57:1]
  ...
  %a.addr = getelementptr [3 x i24]* %a, i64 0, i64 %tmp, !dbg !85 ; [#uses=1 type=i24*] [debug line = 60:13]
  %a.load = load i24* %a.addr, align 4, !dbg !85  ; [#uses=3 type=i24] [debug line = 60:13]
  %tmp.5 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %a.load, i32 0, i32 7), !dbg !85 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp. = sext i8 %tmp.5 to i16, !dbg !85         ; [#uses=1 type=i16] [debug line = 60:13]
  %b.addr = getelementptr [3 x i24]* %b, i64 0, i64 %tmp.2, !dbg !85 ; [#uses=1 type=i24*] [debug line = 60:13]
  %b.load = load i24* %b.addr, align 4, !dbg !85  ; [#uses=3 type=i24] [debug line = 60:13]
  %tmp.6 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %b.load, i32 0, i32 7), !dbg !85 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.4 = sext i8 %tmp.6 to i16, !dbg !85        ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7 = mul i16 %tmp.4, %tmp., !dbg !85        ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.9 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %a.load, i32 8, i32 15), !dbg !85 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.5.1 = sext i8 %tmp.9 to i16, !dbg !85      ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.8 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %b.load, i32 8, i32 15), !dbg !85 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.6.1 = sext i8 %tmp.8 to i16, !dbg !85      ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7.1 = mul i16 %tmp.6.1, %tmp.5.1, !dbg !85 ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.10 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %a.load, i32 16, i32 23), !dbg !85 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.5.2 = sext i8 %tmp.10 to i16, !dbg !85     ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.11 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %b.load, i32 16, i32 23), !dbg !85 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.6.2 = sext i8 %tmp.11 to i16, !dbg !85     ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7.2 = mul i16 %tmp.6.2, %tmp.5.2, !dbg !85 ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp1 = add i16 %tmp.7.2, %tmp.7, !dbg !85      ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.8.2 = add i16 %tmp.7.1, %tmp1, !dbg !85    ; [#uses=1 type=i16] [debug line = 60:13]
  store i16 %tmp.8.2, i16* %res.addr, align 2, !dbg !85 ; [debug line = 60:13]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str3, i32 %tmp.3) nounwind, !dbg !88 ; [#uses=0 type=i32] [debug line = 62:7]
...
; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str2, i32 %tmp.1) nounwind, !dbg !91 ; [#uses=0 type=i32] [debug line = 63:4]
...
; <label>:10                                      ; preds = %1
  ret void, !dbg !94                              ; [debug line = 65:1]
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"/home/parallels/source_code/ECE_527_testing_code/testing_code/HLS_demo_code/Vivado_HLS_Tutorial/Design_Optimization/lab1/matrixmul_prj/solution4/.autopilot/db/matrixmul.pragma.2.cpp", metadata !"/home/parallels/source_code/ECE_527_testing_code/testing_code/HLS_demo_code/Vivado_HLS_Tutorial/Design_Optimization/lab1", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !24} ; [ DW_TAG_compile_unit ]
...
!82 = metadata !{i32 56, i32 25, metadata !81, null}
!83 = metadata !{i32 56, i32 40, metadata !80, null}
!84 = metadata !{i32 57, i32 1, metadata !80, null}
!85 = metadata !{i32 60, i32 13, metadata !86, null}
!86 = metadata !{i32 786443, metadata !87, i32 59, i32 46, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!87 = metadata !{i32 786443, metadata !80, i32 59, i32 19, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!88 = metadata !{i32 62, i32 7, metadata !80, null}
...
!91 = metadata !{i32 63, i32 4, metadata !78, null}
...
!94 = metadata !{i32 65, i32 1, metadata !76, null}
