; ModuleID = '/home/parallels/source_code/ECE_527_testing_code/testing_code/HLS_demo_code/Vivado_HLS_Tutorial/Design_Optimization/lab1/matrixmul_prj/solution6/.autopilot/db/a.g.1.bc'
...
define void @matrixmul([3 x i8]* %a, [3 x i8]* %b, [3 x i16]* %res) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecInterface([3 x i16]* %res, i8* getelementptr inbounds ([8 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !39 ; [debug line = 53:1]
  call void (...)* @_ssdm_op_SpecInterface([3 x i8]* %b, i8* getelementptr inbounds ([8 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !39 ; [debug line = 53:1]
  call void (...)* @_ssdm_op_SpecInterface([3 x i8]* %a, i8* getelementptr inbounds ([8 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !39 ; [debug line = 53:1]
  call void (...)* @_ssdm_SpecArrayReshape([3 x i8]* %b, i32 1, i8* getelementptr inbounds ([9 x i8]* @.str2, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !39 ; [debug line = 53:1]
  call void (...)* @_ssdm_SpecArrayReshape([3 x i8]* %a, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str2, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !39 ; [debug line = 53:1]
...
; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !51 ; [debug line = 59:47]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !51 ; [#uses=1 type=i32] [debug line = 59:47]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !53 ; [debug line = 60:1]
  ...
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str5, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !55 ; [#uses=0 type=i32] [debug line = 61:10]
...
; <label>:7                                       ; preds = %5
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str4, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !58 ; [#uses=0 type=i32] [debug line = 62:7]
...
; <label>:8                                       ; preds = %3
  %rend6 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str3, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !61 ; [#uses=0 type=i32] [debug line = 63:4]
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"/home/parallels/source_code/ECE_527_testing_code/testing_code/HLS_demo_code/Vivado_HLS_Tutorial/Design_Optimization/lab1/matrixmul_prj/solution6/.autopilot/db/matrixmul.pragma.2.cpp", metadata !"/home/parallels/source_code/ECE_527_testing_code/testing_code/HLS_demo_code/Vivado_HLS_Tutorial/Design_Optimization/lab1", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !24} ; [ DW_TAG_compile_unit ]
...
!50 = metadata !{i32 786443, metadata !45, i32 59, i32 19, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
...
!58 = metadata !{i32 62, i32 7, metadata !45, null}
...
!61 = metadata !{i32 63, i32 4, metadata !43, null}
