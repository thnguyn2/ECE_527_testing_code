...
; <label>:4                                       ; preds = %6, %3
  ...
  br i1 %exitcond1, label %8, label %6, !dbg !61  ; [debug line = 56:25]
...
; <label>:6                                       ; preds = %4
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str2) nounwind, !dbg !63 ; [debug line = 57:1]
  ...
  %a.addr = getelementptr [3 x [3 x i8]]* %a, i64 0, i64 %tmp, i64 0, !dbg !64 ; [#uses=1 type=i8*] [debug line = 60:13]
  %a.load = load i8* %a.addr, align 1, !dbg !64   ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.5 = sext i8 %a.load to i16, !dbg !64       ; [#uses=1 type=i16] [debug line = 60:13]
  %b.addr = getelementptr [3 x [3 x i8]]* %b, i64 0, i64 0, i64 %tmp.2, !dbg !64 ; [#uses=1 type=i8*] [debug line = 60:13]
  %b.load = load i8* %b.addr, align 1, !dbg !64   ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.6 = sext i8 %b.load to i16, !dbg !64       ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7 = mul i16 %tmp.6, %tmp.5, !dbg !64       ; [#uses=1 type=i16] [debug line = 60:13]
  %a.addr.1 = getelementptr [3 x [3 x i8]]* %a, i64 0, i64 %tmp, i64 1, !dbg !64 ; [#uses=1 type=i8*] [debug line = 60:13]
  %a.load.1 = load i8* %a.addr.1, align 1, !dbg !64 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.5.1 = sext i8 %a.load.1 to i16, !dbg !64   ; [#uses=1 type=i16] [debug line = 60:13]
  %b.addr.1 = getelementptr [3 x [3 x i8]]* %b, i64 0, i64 1, i64 %tmp.2, !dbg !64 ; [#uses=1 type=i8*] [debug line = 60:13]
  %b.load.1 = load i8* %b.addr.1, align 1, !dbg !64 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.6.1 = sext i8 %b.load.1 to i16, !dbg !64   ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7.1 = mul i16 %tmp.6.1, %tmp.5.1, !dbg !64 ; [#uses=1 type=i16] [debug line = 60:13]
  %a.addr.2 = getelementptr [3 x [3 x i8]]* %a, i64 0, i64 %tmp, i64 2, !dbg !64 ; [#uses=1 type=i8*] [debug line = 60:13]
  %a.load.2 = load i8* %a.addr.2, align 1, !dbg !64 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.5.2 = sext i8 %a.load.2 to i16, !dbg !64   ; [#uses=1 type=i16] [debug line = 60:13]
  %b.addr.2 = getelementptr [3 x [3 x i8]]* %b, i64 0, i64 2, i64 %tmp.2, !dbg !64 ; [#uses=1 type=i8*] [debug line = 60:13]
  %b.load.2 = load i8* %b.addr.2, align 1, !dbg !64 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.6.2 = sext i8 %b.load.2 to i16, !dbg !64   ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7.2 = mul i16 %tmp.6.2, %tmp.5.2, !dbg !64 ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp1 = add i16 %tmp.7.2, %tmp.7, !dbg !64      ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.8.2 = add i16 %tmp.7.1, %tmp1, !dbg !64    ; [#uses=1 type=i16] [debug line = 60:13]
  store i16 %tmp.8.2, i16* %res.addr, align 2, !dbg !64 ; [debug line = 60:13]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str1, i32 %tmp.3) nounwind, !dbg !67 ; [#uses=0 type=i32] [debug line = 62:7]
...
; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str, i32 %tmp.1) nounwind, !dbg !70 ; [#uses=0 type=i32] [debug line = 63:4]
...
; <label>:10                                      ; preds = %1
  ret void, !dbg !73                              ; [debug line = 65:1]
}
...
!64 = metadata !{i32 60, i32 13, metadata !65, null}
!65 = metadata !{i32 786443, metadata !66, i32 59, i32 46, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!66 = metadata !{i32 786443, metadata !59, i32 59, i32 19, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!67 = metadata !{i32 62, i32 7, metadata !59, null}
...
!70 = metadata !{i32 63, i32 4, metadata !57, null}
...
!73 = metadata !{i32 65, i32 1, metadata !55, null}
