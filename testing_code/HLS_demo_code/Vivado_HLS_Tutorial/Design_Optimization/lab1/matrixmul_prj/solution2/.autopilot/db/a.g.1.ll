; ModuleID = '/home/parallels/source_code/ECE_527_testing_code/testing_code/HLS_demo_code/Vivado_HLS_Tutorial/Design_Optimization/lab1/matrixmul_prj/solution2/.autopilot/db/a.g.1.bc'
...
; <label>:6                                       ; preds = %5
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !52 ; [debug line = 60:1]
  %tmp.4 = sext i32 %k to i64, !dbg !53           ; [#uses=2 type=i64] [debug line = 60:13]
  %a.addr = getelementptr inbounds [3 x i8]* %a, i64 %tmp, i64 %tmp.4, !dbg !53 ; [#uses=1 type=i8*] [debug line = 60:13]
  %a.load = load i8* %a.addr, align 1, !dbg !53   ; [#uses=2 type=i8] [debug line = 60:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %a.load) nounwind
  %tmp.5 = sext i8 %a.load to i16, !dbg !53       ; [#uses=1 type=i16] [debug line = 60:13]
  %b.addr = getelementptr inbounds [3 x i8]* %b, i64 %tmp.4, i64 %tmp.2, !dbg !53 ; [#uses=1 type=i8*] [debug line = 60:13]
  %b.load = load i8* %b.addr, align 1, !dbg !53   ; [#uses=2 type=i8] [debug line = 60:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %b.load) nounwind
  %tmp.6 = sext i8 %b.load to i16, !dbg !53       ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7 = mul i16 %tmp.6, %tmp.5, !dbg !53       ; [#uses=1 type=i16] [debug line = 60:13]
  %res.load = load i16* %res.addr, align 2, !dbg !53 ; [#uses=2 type=i16] [debug line = 60:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %res.load) nounwind
  %tmp.8 = add i16 %res.load, %tmp.7, !dbg !53    ; [#uses=1 type=i16] [debug line = 60:13]
  store i16 %tmp.8, i16* %res.addr, align 2, !dbg !53 ; [debug line = 60:13]
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !54 ; [#uses=0 type=i32] [debug line = 61:10]
...
; <label>:7                                       ; preds = %5
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !57 ; [#uses=0 type=i32] [debug line = 62:7]
...
; <label>:8                                       ; preds = %3
  %rend6 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !60 ; [#uses=0 type=i32] [debug line = 63:4]
...
; <label>:9                                       ; preds = %1
  ret void, !dbg !63                              ; [debug line = 65:1]
}
...
!52 = metadata !{i32 60, i32 1, metadata !51, null}
!53 = metadata !{i32 60, i32 13, metadata !51, null}
!54 = metadata !{i32 61, i32 10, metadata !51, null}
!55 = metadata !{i32 59, i32 41, metadata !49, null}
!56 = metadata !{i32 786688, metadata !49, metadata !"k", metadata !6, i32 59, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!57 = metadata !{i32 62, i32 7, metadata !44, null}
...
!60 = metadata !{i32 63, i32 4, metadata !42, null}
...
!63 = metadata !{i32 65, i32 1, metadata !36, null}
