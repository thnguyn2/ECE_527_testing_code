...
; <label>:1                                       ; preds = %13, %0
  ...
  br i1 %exitcond2, label %15, label %3, !dbg !53 ; [debug line = 54:22]
...
; <label>:4                                       ; preds = %11, %3
  ...
  br i1 %exitcond1, label %13, label %6, !dbg !61 ; [debug line = 56:25]
...
; <label>:7                                       ; preds = %9, %6
  ...
  br i1 %exitcond, label %11, label %9, !dbg !63  ; [debug line = 59:32]

; <label>:9                                       ; preds = %7
  call void (...)* @_ssdm_op_SpecLoopName([8 x i8]* @.str2) nounwind, !dbg !65 ; [debug line = 59:47]
  %tmp.9 = call i32 (...)* @_ssdm_op_SpecRegionBegin([8 x i8]* @.str2) nounwind, !dbg !65 ; [#uses=1 type=i32] [debug line = 59:47]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str3) nounwind, !dbg !67 ; [debug line = 60:1]
  %tmp.4 = zext i2 %k to i64, !dbg !68            ; [#uses=2 type=i64] [debug line = 60:13]
  %a.addr = getelementptr [3 x [3 x i8]]* %a, i64 0, i64 %tmp, i64 %tmp.4, !dbg !68 ; [#uses=1 type=i8*] [debug line = 60:13]
  %a.load = load i8* %a.addr, align 1, !dbg !68   ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.5 = sext i8 %a.load to i16, !dbg !68       ; [#uses=1 type=i16] [debug line = 60:13]
  %b.addr = getelementptr [3 x [3 x i8]]* %b, i64 0, i64 %tmp.4, i64 %tmp.2, !dbg !68 ; [#uses=1 type=i8*] [debug line = 60:13]
  %b.load = load i8* %b.addr, align 1, !dbg !68   ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.6 = sext i8 %b.load to i16, !dbg !68       ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7 = mul i16 %tmp.6, %tmp.5, !dbg !68       ; [#uses=1 type=i16] [debug line = 60:13]
  %res.load = load i16* %res.addr, align 2, !dbg !68 ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.8 = add i16 %tmp.7, %res.load, !dbg !68    ; [#uses=1 type=i16] [debug line = 60:13]
  store i16 %tmp.8, i16* %res.addr, align 2, !dbg !68 ; [debug line = 60:13]
  %10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([8 x i8]* @.str2, i32 %tmp.9) nounwind, !dbg !69 ; [#uses=0 type=i32] [debug line = 61:10]
  %k.1 = add i2 %k, 1, !dbg !70                   ; [#uses=1 type=i2] [debug line = 59:41]
  call void @llvm.dbg.value(metadata !{i2 %k.1}, i64 0, metadata !71), !dbg !70 ; [debug line = 59:41] [debug variable = k]
  br label %7, !dbg !70                           ; [debug line = 59:41]

; <label>:11                                      ; preds = %7
  %12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str1, i32 %tmp.3) nounwind, !dbg !72 ; [#uses=0 type=i32] [debug line = 62:7]
  %j.1 = add i2 %j, 1, !dbg !73                   ; [#uses=1 type=i2] [debug line = 56:34]
  call void @llvm.dbg.value(metadata !{i2 %j.1}, i64 0, metadata !74), !dbg !73 ; [debug line = 56:34] [debug variable = j]
  br label %4, !dbg !73                           ; [debug line = 56:34]

; <label>:13                                      ; preds = %4
  %14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str, i32 %tmp.1) nounwind, !dbg !75 ; [#uses=0 type=i32] [debug line = 63:4]
  %i.1 = add i2 %i, 1, !dbg !76                   ; [#uses=1 type=i2] [debug line = 54:31]
  call void @llvm.dbg.value(metadata !{i2 %i.1}, i64 0, metadata !77), !dbg !76 ; [debug line = 54:31] [debug variable = i]
  br label %1, !dbg !76                           ; [debug line = 54:31]

; <label>:15                                      ; preds = %1
  ret void, !dbg !78                              ; [debug line = 65:1]
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"/home/parallels/source_code/ECE_527_testing_code/testing_code/HLS_demo_code/Vivado_HLS_Tutorial/Design_Optimization/lab1/matrixmul_prj/solution2/.autopilot/db/matrixmul.pragma.2.cpp", metadata !"/home/parallels/source_code/ECE_527_testing_code/testing_code/HLS_demo_code/Vivado_HLS_Tutorial/Design_Optimization/lab1", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !24} ; [ DW_TAG_compile_unit ]
...
!67 = metadata !{i32 60, i32 1, metadata !66, null}
!68 = metadata !{i32 60, i32 13, metadata !66, null}
!69 = metadata !{i32 61, i32 10, metadata !66, null}
!70 = metadata !{i32 59, i32 41, metadata !64, null}
!71 = metadata !{i32 786688, metadata !64, metadata !"k", metadata !6, i32 59, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!72 = metadata !{i32 62, i32 7, metadata !59, null}
!73 = metadata !{i32 56, i32 34, metadata !60, null}
!74 = metadata !{i32 786688, metadata !60, metadata !"j", metadata !6, i32 56, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!75 = metadata !{i32 63, i32 4, metadata !57, null}
!76 = metadata !{i32 54, i32 31, metadata !54, null}
!77 = metadata !{i32 786688, metadata !54, metadata !"i", metadata !6, i32 54, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!78 = metadata !{i32 65, i32 1, metadata !55, null}
