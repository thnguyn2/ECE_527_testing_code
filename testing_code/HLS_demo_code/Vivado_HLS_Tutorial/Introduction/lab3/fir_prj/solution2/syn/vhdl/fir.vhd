...
architecture behav of fir is 
    ...
    "fir,hls_ip_2015_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.430000,HLS_SYN_LAT=78,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=276,HLS_SYN_LUT=193}";
    ...
    signal i_cast_reg_202 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal i_1_fu_180_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_1_reg_230 : STD_LOGIC_VECTOR (4 downto 0);
    signal c_load_reg_235 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_cseq_ST_st4_fsm_3 : STD_LOGIC;
    signal ap_sig_bdd_107 : BOOLEAN;
    signal grp_fu_186_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_reg_240 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_4_fu_172_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_5_fu_176_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_7_fu_157_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_2_fu_161_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((tmp_fu_143_p3 = ap_const_lv1_0)))) then 
                    x_ap_vld_preg <= ap_const_logic_0;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (tmp_1_reg_211 = ap_const_lv1_0))) then 
                data1_reg_128 <= shift_reg_q0;
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (tmp_fu_143_p3 = ap_const_lv1_0) and not((tmp_1_fu_151_p2 = ap_const_lv1_0)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1)) then
                i_cast_reg_202 <= i_cast_fu_139_p1;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (tmp_fu_143_p3 = ap_const_lv1_0))) then
                tmp_1_reg_211 <= tmp_1_fu_151_p2;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6)) then
                tmp_6_reg_240 <= grp_fu_186_p2;
            end if;
        end if;
    end process;

    -- the next state (ap_NS_fsm) of the state machine. --
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_sig_bdd_64, tmp_fu_143_p3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_st2_fsm_1 => 
                if (not((tmp_fu_143_p3 = ap_const_lv1_0))) then
                    ap_NS_fsm <= ap_ST_st1_fsm_0;
                else
    ...
    acc_1_fu_191_p2 <= std_logic_vector(signed(tmp_6_reg_240) + signed(acc_reg_103));

    -- ap_done assign process. --
    ap_done_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, tmp_fu_143_p3)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((tmp_fu_143_p3 = ap_const_lv1_0)))) then 
    ...
    ap_ready_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, tmp_fu_143_p3)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((tmp_fu_143_p3 = ap_const_lv1_0)))) then 
    ...
    c_address0 <= tmp_5_fu_176_p1(4 - 1 downto 0);
    ...
    grp_fu_186_p0 <= c_load_reg_235;
    grp_fu_186_p1 <= data1_reg_128;
    i_1_fu_180_p2 <= std_logic_vector(unsigned(i_reg_116) + unsigned(ap_const_lv5_1F));
        i_cast_fu_139_p1 <= std_logic_vector(resize(signed(i_reg_116),32));


    -- shift_reg_address0 assign process. --
    shift_reg_address0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, tmp_1_fu_151_p2, tmp_fu_143_p3, ap_sig_cseq_ST_st3_fsm_2, tmp_3_fu_167_p1, tmp_4_fu_172_p1)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2)) then 
            shift_reg_address0 <= tmp_4_fu_172_p1(4 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (tmp_fu_143_p3 = ap_const_lv1_0) and not((tmp_1_fu_151_p2 = ap_const_lv1_0)))) then 
            shift_reg_address0 <= ap_const_lv4_0;
        elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (tmp_fu_143_p3 = ap_const_lv1_0) and (tmp_1_fu_151_p2 = ap_const_lv1_0))) then 
            shift_reg_address0 <= tmp_3_fu_167_p1(4 - 1 downto 0);
        else 
    ...
    shift_reg_ce0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, tmp_1_fu_151_p2, tmp_fu_143_p3, ap_sig_cseq_ST_st3_fsm_2)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (tmp_fu_143_p3 = ap_const_lv1_0) and (tmp_1_fu_151_p2 = ap_const_lv1_0)) or (ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) or ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (tmp_fu_143_p3 = ap_const_lv1_0) and not((tmp_1_fu_151_p2 = ap_const_lv1_0))))) then 
    ...
    shift_reg_d0_assign_proc : process(x_in_sig, shift_reg_q0, ap_sig_cseq_ST_st2_fsm_1, tmp_1_fu_151_p2, tmp_fu_143_p3, ap_sig_cseq_ST_st3_fsm_2)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2)) then 
    ...
    shift_reg_we0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, tmp_1_fu_151_p2, tmp_1_reg_211, tmp_fu_143_p3, ap_sig_cseq_ST_st3_fsm_2)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (tmp_1_reg_211 = ap_const_lv1_0)) or ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (tmp_fu_143_p3 = ap_const_lv1_0) and not((tmp_1_fu_151_p2 = ap_const_lv1_0))))) then 
    ...
    tmp_1_fu_151_p2 <= "1" when (i_reg_116 = ap_const_lv5_0) else "0";
    tmp_2_fu_161_p2 <= std_logic_vector(signed(ap_const_lv4_F) + signed(tmp_7_fu_157_p1));
    tmp_3_fu_167_p1 <= std_logic_vector(resize(unsigned(tmp_2_fu_161_p2),64));
    tmp_4_fu_172_p1 <= std_logic_vector(resize(unsigned(i_cast_reg_202),64));
    tmp_5_fu_176_p1 <= std_logic_vector(resize(unsigned(i_cast_reg_202),64));
    tmp_7_fu_157_p1 <= i_reg_116(4 - 1 downto 0);
    tmp_fu_143_p3 <= i_reg_116(4 downto 4);
    ...
    y_ap_vld_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, tmp_fu_143_p3)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((tmp_fu_143_p3 = ap_const_lv1_0)))) then 
