...
(* CORE_GENERATION_INFO="fir,hls_ip_2015_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.430000,HLS_SYN_LAT=78,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=276,HLS_SYN_LUT=193}" *)
...
reg    ap_sig_bdd_64;
wire  signed [31:0] i_cast_fu_139_p1;
reg  signed [31:0] i_cast_reg_202;
...
reg    ap_sig_bdd_93;
wire   [4:0] i_1_fu_180_p2;
reg   [4:0] i_1_reg_230;
reg  signed [31:0] c_load_reg_235;
reg    ap_sig_cseq_ST_st4_fsm_3;
reg    ap_sig_bdd_107;
wire  signed [31:0] grp_fu_186_p2;
reg  signed [31:0] tmp_6_reg_240;
reg    ap_sig_cseq_ST_st7_fsm_6;
reg    ap_sig_bdd_116;
wire  signed [31:0] acc_1_fu_191_p2;
...
wire   [63:0] tmp_4_fu_172_p1;
wire   [63:0] tmp_5_fu_176_p1;
wire   [3:0] tmp_7_fu_157_p1;
wire   [3:0] tmp_2_fu_161_p2;
wire  signed [31:0] grp_fu_186_p0;
...
begin : ap_ret_x_ap_vld_preg
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & ~(tmp_fu_143_p3 == ap_const_lv1_0))) begin
            x_ap_vld_preg <= ap_const_logic_0;
...
always @(posedge ap_clk)
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2) & (tmp_1_reg_211 == ap_const_lv1_0))) begin
        data1_reg_128 <= shift_reg_q0;
    end else if (((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & (tmp_fu_143_p3 == ap_const_lv1_0) & ~(tmp_1_fu_151_p2 == ap_const_lv1_0))) begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or tmp_fu_143_p3)
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & ~(tmp_fu_143_p3 == ap_const_lv1_0))) begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or tmp_1_fu_151_p2 or tmp_fu_143_p3 or ap_sig_cseq_ST_st3_fsm_2 or tmp_3_fu_167_p1 or tmp_4_fu_172_p1)
begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        shift_reg_address0 = tmp_4_fu_172_p1;
    end else if (((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & (tmp_fu_143_p3 == ap_const_lv1_0) & ~(tmp_1_fu_151_p2 == ap_const_lv1_0))) begin
        shift_reg_address0 = ap_const_lv4_0;
    end else if (((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & (tmp_fu_143_p3 == ap_const_lv1_0) & (tmp_1_fu_151_p2 == ap_const_lv1_0))) begin
        shift_reg_address0 = tmp_3_fu_167_p1;
    end else begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or tmp_1_fu_151_p2 or tmp_fu_143_p3 or ap_sig_cseq_ST_st3_fsm_2)
begin
    if ((((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & (tmp_fu_143_p3 == ap_const_lv1_0) & (tmp_1_fu_151_p2 == ap_const_lv1_0)) | (ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2) | ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & (tmp_fu_143_p3 == ap_const_lv1_0) & ~(tmp_1_fu_151_p2 == ap_const_lv1_0)))) begin
...
always @ (x_in_sig or shift_reg_q0 or ap_sig_cseq_ST_st2_fsm_1 or tmp_1_fu_151_p2 or tmp_fu_143_p3 or ap_sig_cseq_ST_st3_fsm_2)
begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2)) begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or tmp_1_fu_151_p2 or tmp_1_reg_211 or tmp_fu_143_p3 or ap_sig_cseq_ST_st3_fsm_2)
begin
    if ((((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2) & (tmp_1_reg_211 == ap_const_lv1_0)) | ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & (tmp_fu_143_p3 == ap_const_lv1_0) & ~(tmp_1_fu_151_p2 == ap_const_lv1_0)))) begin
...
always @ (ap_CS_fsm or ap_sig_bdd_64 or tmp_fu_143_p3)
begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
        ...
        ap_ST_st2_fsm_1 : 
        begin
            if (~(tmp_fu_143_p3 == ap_const_lv1_0)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
...
assign acc_1_fu_191_p2 = ($signed(tmp_6_reg_240) + $signed(acc_reg_103));
...
assign c_address0 = tmp_5_fu_176_p1;
assign grp_fu_186_ce = ap_const_logic_1;
assign grp_fu_186_p0 = c_load_reg_235;
assign grp_fu_186_p1 = data1_reg_128;
assign i_1_fu_180_p2 = ($signed(i_reg_116) + $signed(ap_const_lv5_1F));
assign i_cast_fu_139_p1 = $signed(i_reg_116);
assign tmp_1_fu_151_p2 = (i_reg_116 == ap_const_lv5_0? 1'b1: 1'b0);
assign tmp_2_fu_161_p2 = ($signed(ap_const_lv4_F) + $signed(tmp_7_fu_157_p1));
assign tmp_3_fu_167_p1 = tmp_2_fu_161_p2;
assign tmp_4_fu_172_p1 = $unsigned(i_cast_reg_202);
assign tmp_5_fu_176_p1 = $unsigned(i_cast_reg_202);
assign tmp_7_fu_157_p1 = i_reg_116[3:0];
assign tmp_fu_143_p3 = i_reg_116[ap_const_lv32_4];
