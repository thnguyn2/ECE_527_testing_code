; ModuleID = '/home/parallels/source_code/ECE_527_testing_code/testing_code/HLS_demo_code/Vivado_HLS_Tutorial/Introduction/lab3/fir_prj/solution2/.autopilot/db/a.g.1.bc'
...
define void @fir(i32* %y, i32* %c, i32 %x) nounwind uwtable {
  ...
  br label %1, !dbg !32                           ; [debug line = 65:26]

; <label>:1                                       ; preds = %5, %0
  %acc = phi i32 [ 0, %0 ], [ %acc.1, %5 ]        ; [#uses=2 type=i32]
  %i = phi i32 [ 10, %0 ], [ %i.1, %5 ]           ; [#uses=6 type=i32]
  %tmp = icmp sgt i32 %i, -1, !dbg !32            ; [#uses=1 type=i1] [debug line = 65:26]
  br i1 %tmp, label %2, label %6, !dbg !32        ; [debug line = 65:26]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([17 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !34 ; [debug line = 65:45]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([17 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !34 ; [#uses=1 type=i32] [debug line = 65:45]
  %tmp.1 = icmp eq i32 %i, 0, !dbg !36            ; [#uses=1 type=i1] [debug line = 66:2]
  br i1 %tmp.1, label %3, label %4, !dbg !36      ; [debug line = 66:2]

; <label>:3                                       ; preds = %2
  store i32 %x, i32* getelementptr inbounds ([11 x i32]* @shift_reg, i64 0, i64 0), align 16, !dbg !37 ; [debug line = 67:4]
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !39), !dbg !40 ; [debug line = 68:4] [debug variable = data]
  br label %5, !dbg !41                           ; [debug line = 69:5]

; <label>:4                                       ; preds = %2
  %tmp.2 = add nsw i32 %i, -1, !dbg !42           ; [#uses=1 type=i32] [debug line = 70:4]
  %tmp.3 = sext i32 %tmp.2 to i64, !dbg !42       ; [#uses=1 type=i64] [debug line = 70:4]
  %shift_reg.addr = getelementptr inbounds [11 x i32]* @shift_reg, i64 0, i64 %tmp.3, !dbg !42 ; [#uses=1 type=i32*] [debug line = 70:4]
  %data = load i32* %shift_reg.addr, align 4, !dbg !42 ; [#uses=4 type=i32] [debug line = 70:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %data) nounwind
  %tmp.4 = sext i32 %i to i64, !dbg !42           ; [#uses=1 type=i64] [debug line = 70:4]
  %shift_reg.addr.1 = getelementptr inbounds [11 x i32]* @shift_reg, i64 0, i64 %tmp.4, !dbg !42 ; [#uses=1 type=i32*] [debug line = 70:4]
  store i32 %data, i32* %shift_reg.addr.1, align 4, !dbg !42 ; [debug line = 70:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %data) nounwind
  call void @llvm.dbg.value(metadata !{i32 %data}, i64 0, metadata !39), !dbg !44 ; [debug line = 71:4] [debug variable = data]
  br label %5

; <label>:5                                       ; preds = %4, %3
  %data1 = phi i32 [ %x, %3 ], [ %data, %4 ]      ; [#uses=1 type=i32]
  %tmp.5 = sext i32 %i to i64, !dbg !45           ; [#uses=1 type=i64] [debug line = 73:5]
  %c.addr = getelementptr inbounds i32* %c, i64 %tmp.5, !dbg !45 ; [#uses=1 type=i32*] [debug line = 73:5]
  %c.load = load i32* %c.addr, align 4, !dbg !45  ; [#uses=2 type=i32] [debug line = 73:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %c.load) nounwind
  %tmp.6 = mul nsw i32 %c.load, %data1, !dbg !45  ; [#uses=1 type=i32] [debug line = 73:5]
  %acc.1 = add nsw i32 %tmp.6, %acc, !dbg !45     ; [#uses=1 type=i32] [debug line = 73:5]
  call void @llvm.dbg.value(metadata !{i32 %acc.1}, i64 0, metadata !46), !dbg !45 ; [debug line = 73:5] [debug variable = acc]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([17 x i8]* @.str3, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !48 ; [#uses=0 type=i32] [debug line = 74:3]
  %i.1 = add nsw i32 %i, -1, !dbg !49             ; [#uses=1 type=i32] [debug line = 65:39]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !50), !dbg !49 ; [debug line = 65:39] [debug variable = i]
  br label %1, !dbg !49                           ; [debug line = 65:39]

; <label>:6                                       ; preds = %1
  %acc.0.lcssa = phi i32 [ %acc, %1 ]             ; [#uses=1 type=i32]
  store i32 %acc.0.lcssa, i32* %y, align 4, !dbg !51 ; [debug line = 75:3]
  ret void, !dbg !52                              ; [debug line = 76:1]
}
...
!32 = metadata !{i32 65, i32 26, metadata !33, null}
!33 = metadata !{i32 786443, metadata !29, i32 65, i32 21, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!34 = metadata !{i32 65, i32 45, metadata !35, null}
!35 = metadata !{i32 786443, metadata !33, i32 65, i32 44, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!36 = metadata !{i32 66, i32 2, metadata !35, null}
!37 = metadata !{i32 67, i32 4, metadata !38, null}
!38 = metadata !{i32 786443, metadata !35, i32 66, i32 12, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!39 = metadata !{i32 786688, metadata !29, metadata !"data", metadata !6, i32 61, metadata !10, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!40 = metadata !{i32 68, i32 4, metadata !38, null}
!41 = metadata !{i32 69, i32 5, metadata !38, null}
!42 = metadata !{i32 70, i32 4, metadata !43, null}
!43 = metadata !{i32 786443, metadata !35, i32 69, i32 12, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!44 = metadata !{i32 71, i32 4, metadata !43, null}
!45 = metadata !{i32 73, i32 5, metadata !35, null}
!46 = metadata !{i32 786688, metadata !29, metadata !"acc", metadata !6, i32 60, metadata !47, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!47 = metadata !{i32 786454, null, metadata !"acc_t", metadata !6, i32 52, i64 0, i64 0, i64 0, i32 0, metadata !11} ; [ DW_TAG_typedef ]
!48 = metadata !{i32 74, i32 3, metadata !35, null}
!49 = metadata !{i32 65, i32 39, metadata !33, null}
!50 = metadata !{i32 786688, metadata !29, metadata !"i", metadata !6, i32 62, metadata !11, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!51 = metadata !{i32 75, i32 3, metadata !29, null}
!52 = metadata !{i32 76, i32 1, metadata !29, null}
