; ModuleID = '/home/parallels/source_code/ECE_527_testing_code/testing_code/HLS_demo_code/Vivado_HLS_Tutorial/Introduction/lab3/fir_prj/solution2/.autopilot/db/a.o.3.bc'
...
define void @fir(i32* %y, [11 x i32]* %c, i32 %x) nounwind uwtable {
  ...
  br label %1, !dbg !41                           ; [debug line = 65:26]

; <label>:1                                       ; preds = %5, %0
  %acc = phi i32 [ 0, %0 ], [ %acc_1, %5 ]        ; [#uses=2 type=i32]
  %i = phi i5 [ 10, %0 ], [ %i_1, %5 ]            ; [#uses=5 type=i5]
  %i_cast = sext i5 %i to i32, !dbg !41           ; [#uses=2 type=i32] [debug line = 65:26]
  %tmp = call i1 @_ssdm_op_BitSelect.i1.i5.i32(i5 %i, i32 4), !dbg !41 ; [#uses=1 type=i1] [debug line = 65:26]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 11, i64 11, i64 11) nounwind ; [#uses=0 type=i32]
  br i1 %tmp, label %6, label %2, !dbg !41        ; [debug line = 65:26]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([17 x i8]* @p_str3) nounwind, !dbg !43 ; [debug line = 65:45]
  %tmp_1 = icmp eq i5 %i, 0, !dbg !45             ; [#uses=1 type=i1] [debug line = 66:2]
  br i1 %tmp_1, label %3, label %4, !dbg !45      ; [debug line = 66:2]

; <label>:3                                       ; preds = %2
  store i32 %x_read, i32* getelementptr inbounds ([11 x i32]* @shift_reg, i64 0, i64 0), align 16, !dbg !46 ; [debug line = 67:4]
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !48), !dbg !49 ; [debug line = 68:4] [debug variable = data]
  br label %5, !dbg !50                           ; [debug line = 69:5]

; <label>:4                                       ; preds = %2
  %tmp_7 = trunc i5 %i to i4, !dbg !41            ; [#uses=1 type=i4] [debug line = 65:26]
  %tmp_2 = add i4 -1, %tmp_7, !dbg !51            ; [#uses=1 type=i4] [debug line = 70:4]
  %tmp_3 = zext i4 %tmp_2 to i64, !dbg !51        ; [#uses=1 type=i64] [debug line = 70:4]
  %shift_reg_addr = getelementptr inbounds [11 x i32]* @shift_reg, i64 0, i64 %tmp_3, !dbg !51 ; [#uses=1 type=i32*] [debug line = 70:4]
  %data = load i32* %shift_reg_addr, align 4, !dbg !51 ; [#uses=2 type=i32] [debug line = 70:4]
  %tmp_4 = zext i32 %i_cast to i64, !dbg !51      ; [#uses=1 type=i64] [debug line = 70:4]
  %shift_reg_addr_1 = getelementptr inbounds [11 x i32]* @shift_reg, i64 0, i64 %tmp_4, !dbg !51 ; [#uses=1 type=i32*] [debug line = 70:4]
  store i32 %data, i32* %shift_reg_addr_1, align 4, !dbg !51 ; [debug line = 70:4]
  call void @llvm.dbg.value(metadata !{i32 %data}, i64 0, metadata !48), !dbg !53 ; [debug line = 71:4] [debug variable = data]
  br label %5

; <label>:5                                       ; preds = %4, %3
  %data1 = phi i32 [ %x_read, %3 ], [ %data, %4 ] ; [#uses=1 type=i32]
  %tmp_5 = zext i32 %i_cast to i64, !dbg !54      ; [#uses=1 type=i64] [debug line = 73:5]
  %c_addr = getelementptr [11 x i32]* %c, i64 0, i64 %tmp_5, !dbg !54 ; [#uses=1 type=i32*] [debug line = 73:5]
  %c_load = load i32* %c_addr, align 4, !dbg !54  ; [#uses=1 type=i32] [debug line = 73:5]
  %tmp_6 = mul nsw i32 %c_load, %data1, !dbg !54  ; [#uses=1 type=i32] [debug line = 73:5]
  %acc_1 = add nsw i32 %tmp_6, %acc, !dbg !54     ; [#uses=1 type=i32] [debug line = 73:5]
  call void @llvm.dbg.value(metadata !{i32 %acc_1}, i64 0, metadata !55), !dbg !54 ; [debug line = 73:5] [debug variable = acc]
  %i_1 = add i5 %i, -1, !dbg !57                  ; [#uses=1 type=i5] [debug line = 65:39]
  call void @llvm.dbg.value(metadata !{i5 %i_1}, i64 0, metadata !58), !dbg !57 ; [debug line = 65:39] [debug variable = i]
  br label %1, !dbg !57                           ; [debug line = 65:39]

; <label>:6                                       ; preds = %1
  call void @_ssdm_op_Write.ap_vld.i32P(i32* %y, i32 %acc) nounwind, !dbg !59 ; [debug line = 75:3]
  ret void, !dbg !60                              ; [debug line = 76:1]
}
...
!41 = metadata !{i32 65, i32 26, metadata !42, null}
!42 = metadata !{i32 786443, metadata !39, i32 65, i32 21, metadata !20, i32 1} ; [ DW_TAG_lexical_block ]
!43 = metadata !{i32 65, i32 45, metadata !44, null}
!44 = metadata !{i32 786443, metadata !42, i32 65, i32 44, metadata !20, i32 2} ; [ DW_TAG_lexical_block ]
!45 = metadata !{i32 66, i32 2, metadata !44, null}
!46 = metadata !{i32 67, i32 4, metadata !47, null}
!47 = metadata !{i32 786443, metadata !44, i32 66, i32 12, metadata !20, i32 3} ; [ DW_TAG_lexical_block ]
...
!50 = metadata !{i32 69, i32 5, metadata !47, null}
!51 = metadata !{i32 70, i32 4, metadata !52, null}
!52 = metadata !{i32 786443, metadata !44, i32 69, i32 12, metadata !20, i32 4} ; [ DW_TAG_lexical_block ]
!53 = metadata !{i32 71, i32 4, metadata !52, null}
!54 = metadata !{i32 73, i32 5, metadata !44, null}
!55 = metadata !{i32 786688, metadata !39, metadata !"acc", metadata !20, i32 60, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!56 = metadata !{i32 786454, null, metadata !"acc_t", metadata !20, i32 52, i64 0, i64 0, i64 0, i32 0, metadata !25} ; [ DW_TAG_typedef ]
!57 = metadata !{i32 65, i32 39, metadata !42, null}
!58 = metadata !{i32 786688, metadata !39, metadata !"i", metadata !20, i32 62, metadata !25, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!59 = metadata !{i32 75, i32 3, metadata !39, null}
!60 = metadata !{i32 76, i32 1, metadata !39, null}
