...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_32s_32s_32_3_U1->din0(grp_fu_174_p0);
    fir_mul_32s_32s_32_3_U1->din1(grp_fu_174_p1);
    fir_mul_32s_32s_32_3_U1->ce(grp_fu_174_ce);
    fir_mul_32s_32s_32_3_U1->dout(grp_fu_174_p2);
...
void fir::thread_acc_1_fu_179_p2() {
    acc_1_fu_179_p2 = (!tmp_6_reg_228.read().is_01() || !acc_reg_91.read().is_01())? sc_lv<32>(): (sc_bigint<32>(tmp_6_reg_228.read()) + sc_biguint<32>(acc_reg_91.read()));
}
...
void fir::thread_grp_fu_174_p0() {
    grp_fu_174_p0 = c_load_reg_223.read();
}
...
void fir::thread_tmp_4_fu_160_p1() {
    tmp_4_fu_160_p1 = esl_zext<64,32>(i_cast_reg_190.read());
}

void fir::thread_tmp_5_fu_164_p1() {
    tmp_5_fu_164_p1 = esl_zext<64,32>(i_cast_reg_190.read());
}
