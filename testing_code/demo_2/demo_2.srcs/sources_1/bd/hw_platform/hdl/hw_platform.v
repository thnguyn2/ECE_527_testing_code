...
(* CORE_GENERATION_INFO = "hw_platform,IP_Integrator,{x_ipProduct=Vivado 2015.1,x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=hw_platform,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,da_ps7_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "hw_platform.hwdef" *) 
module hw_platform
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
